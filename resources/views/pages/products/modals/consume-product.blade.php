                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="d-flex justify-content-center align-items-center my-3 gap-3">
                            ...
                            <input type="number" id="qty" class="form-control text-center" style="width: 100px;"
                                oninput="updateTotal()" name="qty">
                        ...
                        <h5 class="text-center my-3">Итого: <span id="total_price" name="total_price"></span> сум</h5>
